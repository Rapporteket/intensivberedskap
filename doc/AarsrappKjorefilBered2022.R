...
xtable::xtable(tab$Tab, label = 'tab:berkey',
               caption = 'Nøkkeltal basert på opphald for intensivpasientar med covid-19, N=2574')

tab <- intensivberedskap::oppsumFerdigeRegTab(BeredIntPers1aar)
xtable::xtable(tab$Tab, label = 'tab:berkey',
               caption = 'Nøkkeltal basert på smitteforløp for intensivpasientar med covid-19, N=2093')
Ntab <- tab$Ntest
