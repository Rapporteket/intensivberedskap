...
if (!exists('InfluDataAlle')){
      NIRInfluDataSQL <- function(datoFra = '2019-09-25', datoTil = '2099-01-01') {
      ...
      InfluData <- NIRInfluDataSQL(datoFra = '2019-09-30')
}
#library(dplyr)
...
Influensarapportering fra NIR, sesongen 2019/20 }
...
\item Start av influensasesongen 2019/20 er uke 40 i 2019.
...
print(xtable::xtable(TabUkeTot[indAntRader,], digits=0, #align=c('l', rep('r', ncol(TabUkeTot))),
		caption=paste0('Antall influensatilfeller sesongen', sesongTxt, '.')),
