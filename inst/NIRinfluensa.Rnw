...
InfluData <- intensivberedskap::NIRsqlInfluensa(datoFra = '2018-01-01', datoTil = Sys.Date(), preprosess=1)

    #sisteReg <- max(as.Date(InfluData$FormDate))
    #datoU40 <- ifelse(sisteReg >= '2021-10-04','2021-10-04', '2020-09-28')
    #startDato <- datoU40 #ifelse(sisteReg >= datoU40, '2020-09-28', '2019-09-30')
    #sesongTxt <- ifelse(sisteReg >= '2021-10-04', ' 2021/22', '2020/2021')
