...
if (!exists('InfluData')){
      NIRInfluDataSQL <- function(datoFra = '2020-09-28', datoTil = Sys.Date()) {
      ...
      InfluData <- NIRInfluDataSQL(datoFra = '2020-09-28')
}
#library(dplyr)
...
Influensarapportering fra NIR, sesongen 2020/21 }
...
\item Start av influensasesongen 2020/21 er uke 40 i 2020.
