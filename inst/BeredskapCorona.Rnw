...
tittelRHF <- paste0('Rapportering av Covid-19 fra NIPaR, ',
...
\title[Norsk Intensiv- og pandemiregister, covid-19 \\\today] {%\textit{Covid-19data, NIPaR} \\
\Sexpr{tittelRHF}}
...
Dokumentet inneholder oppsummering av covid-19tilfeller hos pasienter som
kvalifiserer for rapportering til NIPaR.
Mistenkte og bekreftede covid-19tilfeller er rapportert i eget skjema i registeret, og data fra dette skjemaet danner grunnlaget for denne rapporten.
\\
...
\begin{frame}[fragile] {Covid-19 på respirator/ECMO}
