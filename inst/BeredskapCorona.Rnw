...
print(xtable::xtable(TabTidEnh[(max(1,AntRader-20)):AntRader, ], digits=0, #method='compact', #align=c('l', rep('r', ncol(alderDIV))),
		caption=paste0('Sist registrerte Coronatilfeller og 20 dager bakover i tid. <<Totalt>> er sum fra 10.mars. \n (B - bekreftet, M - mistenkt)')),
  ...
  xtable::xtable(TabTidEnh[max(1,AntRader-20):AntRader, ], digits=0,
		caption='Siste Coronatilfeller i egen region, samt hele landet. Totalt er sum fra 10.mars.
		\\\ (B - bekreftet, M - mistenkt)')
}
