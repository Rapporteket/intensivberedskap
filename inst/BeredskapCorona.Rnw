...
print(
  xtable::xtable(RegHF , digits=0,
                 caption='Totalt antall registrerte intensivpasienter fra 10. mars 2020 til rapporteringstidspunktet.')
      ,include.rownames = FALSE)
@
\end{frame}
...
txtAlder <- if (dim(RegData)[1]>2){paste0('Alderen i ', enhetTxt,' er mellom ',
