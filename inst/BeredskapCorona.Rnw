...
tittelRHF <- paste0('Coronarapportering fra NIPar, ',
...
\title[Norsk Intensiv- og pandemiregister, covid-19 \\\today] {%\textit{Coronadata, NIPar} \\
\Sexpr{tittelRHF}}
...
print(xtable::xtable(TabTidEnh[(max(1,AntRader-20)):AntRader, ], digits=0,
  ...
  xtable::xtable(TabTidEnh[max(1,AntRader-20):AntRader, ], digits=0,
		caption='Siste Coronaopphold i egen region, samt hele landet. Totalt er sum fra 10. mars 2020.
		\\\ (B - bekreftet, M - mistenkt)')
}
